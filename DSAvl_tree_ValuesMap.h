...
class DSAvl_tree_ValuesMap{    
    ...
    */
    set<Comparable> getKeysAsSet(){
        set<Comparable> theSet;
        getKeysAsSet(root, theSet);
        return theSet;
    }

    /**
     * Returns a string of all the keys
    */
    string getKeysAsString(){
        set<Comparable> theSet = getKeysAsSet();
        string theString = "";
        bool hasKeys = false;
    ...
    */
    string getValuesMapAsString(const Comparable& theKey){
        ...
        // removes the last space and comma added the last iteration if the values actually has values
        if(hasValues){
            theString.pop_back();
            theString.pop_back();
        }
...
private:
    ...
    /**
     * This uses LNR to return a set containing all the keys
    */
   void getKeysAsSet(AvlNode* node, set<Comparable>& theSet)
   {    
        ...
        // L
        getKeysAsSet(node->left, theSet);
        // N
        theSet.insert(node->key);
        // R
